...
import { Upload, BarChart2, FileSpreadsheet, Database, Menu, X, Github } from 'lucide-react';
          ...
          <div className="flex justify-between items-center px-4 md:px-6 py-4">
            ...
            <div className="relative group">
              <a 
                ...
                className="relative px-6 py-4 bg-white rounded-lg block"
              >
                <div>
                  <h1 className="text-2xl font-semibold text-gray-800 group-hover:text-blue-600 transition-colors duration-300">
                    Data Analysis
                  </h1>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="hidden md:flex divide-x divide-gray-200">
                <div className="px-6">
                  ...
                  <p className="text-lg font-medium text-gray-900">{headers.length}</p>
                </div>
                <div className="px-6">
                  <p className="text-sm text-gray-500">Records</p>
                  <p className="text-lg font-medium text-gray-900">{csvData.length}</p>
                </div>
              </div>
